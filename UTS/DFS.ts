...
const databaseResep: Resep[] = [
    { nama: 'Mie Goreng', kategori: 'Masak Cepat', bahanWajib: ['mie instan', 'minyak', 'bawang putih', 'bawang merah', 'garam'] },
    { nama: 'Telur Dadar', kategori: 'Masak Cepat', bahanWajib: ['telur', 'minyak', 'garam'] },
    ...
    { nama: 'Nasi Goreng', kategori: 'Masak Sedang', bahanWajib: ['nasi', 'minyak', 'telur', 'bawang putih', 'bawang merah', 'kecap'] },
    { nama: 'Tempe Goreng', kategori: 'Masak Sedang', bahanWajib: ['tempe', 'minyak', 'garam'] },
    { nama: 'Tumis Kol', kategori: 'Masak Sedang', bahanWajib: ['kol', 'minyak', 'bawang putih', 'bawang merah', 'garam'] },
    { nama: 'Tumis Tempe', kategori: 'Masak Sedang', bahanWajib: ['tempe', 'minyak', 'bawang putih', 'bawang merah', 'kecap'] },
];
...
rl.question('Masukkan bahan-bahan yang Anda miliki (pisahkan dengan koma): ', (input) => {
    ...
    // Cara menjalankan: ketik "npx ts-node dfs.ts" di terminal.
});